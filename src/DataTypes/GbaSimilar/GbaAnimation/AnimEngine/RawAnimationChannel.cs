...
{
    public readonly struct RawAnimationChannel : ISerializerShortLog
    {
        #region Constructor

        public RawAnimationChannel(Game game, ushort attribute0, ushort attribute1, ushort attribute2)
        {
            Game = game;
        ...
        public static RawAnimationChannel CreateSpriteChannel(
            Game game, 
            short xPosition,
            short yPosition,
            byte spriteShape,
            ...
            bool flipY)
        {
            ...
            return new RawAnimationChannel(game, attr0, attr1, attr2);
        }

        public static RawAnimationChannel CreateAffineSpriteChannel(
            Game game, 
            short xPosition,
            short yPosition,
            byte spriteShape,
        ...
        public static RawAnimationChannel CreateSoundChannel(
            Game game, 
            short soundId)
        {
            ushort attr0 = 0;
        ...
        public static RawAnimationChannel CreateDisplacementVectorChannel(
            Game game,
        ...
        public static RawAnimationChannel CreateBoxChannel(
            Game game,
        ...
        public static SerializeInto<RawAnimationChannel> SerializeInto = (s, x) =>
        {
            ...
            return new RawAnimationChannel(settings.Game, v1, v2, v3);
        };
